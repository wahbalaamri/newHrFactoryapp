                    ...
                    <div class="row">
                        <div class="col-xl-2">
                            <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 99 98">
                                ...
                                <polygon class="cls-3"
                                    points="73.4 41.16 76.09 40.41 76.84 43.14 74.12 43.85 73.4 41.16" />
                            ...
                            <div class="bs-stepper linear">
                                ...
                                <div class="bs-stepper-content">
                                    ...
                                    <div id="focalpoint" class="content" role="tabpanel"
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="terms_condtions_box">
                                                            {{ __('I viewed and I agree to') }} <a
                                                                href="javascript:void(0)" data-bs-target="#terms_conditions_modal" data-bs-toggle="modal">{{ 'terms & conditions' }}</a>
                                                        </label>
                                                    </div>
                                                </div>
                                            @endif
                                        ...
                                        <div class="pt-2 pb-4">
                                            <a href="javascript:void(0)" class="btn btn-primary btn-sm float-start"
                                                onclick="stepper.previous()">Previous</a>
                                            <button type="submit" class="btn btn-primary btn-sm float-end"
                                                @disabled($terms != null)>Submit</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
