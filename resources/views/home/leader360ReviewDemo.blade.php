                                                    ...
                                                    @foreach ($practice->questions as $question)
                                                        <fieldset>
                                                            <legend class="mb-5 pb-5 mt-5 pt-5">
                                                                ...
                                                                @if (app()->getLocale() == 'en')
                                                                    @php
                                                                        $expression = $practice->questions->first()
                                                                            ->question;
                                                                    @endphp
                                                                    @if (!$LoopNotFNOTL)
                                                                        {{ $practice->questions->first()->question }}
                                                                    @else
                                                                        {{ substr($expression, 0, 9) . str_repeat('*', strlen($expression)) . substr($expression, -1) }}
                                                                    @endif
                                                                @elseif (app()->getLocale() == 'ar')
                                                                    ...
                                                                    @if (!$LoopNotFNOTL)
                                                                        {{ $practice->questions->first()->question }}
                                                                    @else
                                                                        {{ substr($expression, 0, 1) . str_repeat('*', strlen($expression)) . substr($expression, -1) }}
                                                                    @endif
                                                                @endif
                                                            </legend>
