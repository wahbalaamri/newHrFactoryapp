    ...
    <header class="gradient-white box-shadow">
        ...
        <div class="header-output">
            <div class="container header-in">
                <div class="row">
                    <div class="col-xl-2 col-lg-2"> <a id="logo" href="/"
                            class="d-inline-block margin-tb-10px"><img src="{{ asset('assets/img/logo-1.png') }}"
                                alt=""></a> <a class="mobile-toggle padding-15px background-main-color"
                            href="#"><i class="fas fa-bars"></i></a> </div>
                </div>
            </div>
        </div>
    </header>
                                    ...
                                    <form action="" method="POST" data-bs-multi-step-form>
                                        ...
                                        <div class="progressbar">
                                            ...
                                            @foreach ($functions as $function)
                                                <div @class(['progress-step', 'stpactive' => $loop->first])
                                        ...
                                        @foreach ($functions as $function)
                                            <div @class(['my-wizard-continar', 'active' => $loop->first])>
                                                @foreach ($function->practices as $practice)
                                                    ...
                                                    @endif
                                                    <fieldset>
                                                        <legend class="mb-5 pb-5 mt-5 pt-5" @style(['filter: blur(0.1665rem)' => $LoopNotFNOTL])>
                                                            {{ $loop->iteration }}.
                                                            @if (app()->getLocale() == 'en')
                                                                @php
                                                                ...
                                                                @else
                                                                    {{ substr($expression, 0, 5) . str_repeat('*', strlen($expression)) . substr($expression, -1) }}
                                                                @endif
                                                            ...
                                                            <div class="radio-tile-group">
                                                                ...
                                                                <div class="input-container text-center">
                                                                    ...
                                                                    <div class="radio-tile">
                                                                        ...
                                                                        <label
                                                                            for="survey">{{ __('Strongly Disagree') }}</label>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="input-container text-center">
                                                                    ...
                                                                    <div class="radio-tile">
                                                                        ...
                                                                        <label
                                                                            for="survey">{{ __('Neutral') }}</label>
                                                                    </div>
                                                                </div>
                                                                <div class="input-container text-center">
                                                                    <input id="survey" type="radio"
                                                                        name="survey-{{ $practice->questions->first()->id }}"
                                                                        @checked($LoopNotFNOTL) value="4"
                                                                        class="{{ app()->getLocale() == 'ar' ? 'right-input-margin' : 'left-input-margin' }}">
                                                                    <div class="radio-tile">
                                                                        <i class="fa-regular fa-face-smile"></i>
                                                                        <label
                                                                            for="survey">{{ __('Agree') }}</label>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="input-container text-center">
                                                                    ...
                                                                    <div class="radio-tile">
                                                                        ...
                                                                        <label
                                                                            for="survey">{{ __('Strongly Agree') }}</label>
                                                                    </div>
                                                                </div>
                ...
                if (e.target.matches('[data-bs-submit]')) {
                    ...
                    setTimeout(function() {
                        window.location.href =
                            "{{ route('tools.EmployeeEngagmentResultDemo',['id'=>$email_id]) }}";
                    }, 2000);
                }
