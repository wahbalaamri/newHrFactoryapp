...
<head>
    ...
    <style>
        ...
        body {
            margin: 0;
            font-family: 'amiri', "Source Sans Pro", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol";
            font-size: 1rem;
            font-weight: 400;
            line-height: 1.5;
            color: #212529;
    ...
    <div class="invoice p-3 mb-3">
        <div>
            <div class="row">
                <div class="col-12">
                    <h4>
                        <i class="fas fa-globe"></i>{{ __('HR Policy') }}
            ...
            <div class="row invoice-info text-center mt-5 pt-5">
                <div class="col-12 invoice-col">
                    <figure class="figure">
                        <img src="{{ $image }}" class="figure-img img-fluid rounded" alt="...">
                        <figcaption class="figure-caption text-center">{{ $client->client_name }} {{ __('Logo') }}
                        </figcaption>
                    </figure>
                    <address class="text-center">
                        <strong>{{ $client->client_name }}</strong><br>
                        {{ __('Electronic HR Policy') }}<br>
                        {{ __('Printed Specially For') }} {{ $client->client_name }}<br>
                        {{ __('Printed on ') }}{{ $date }}<br>
                    </address>
                </div>
