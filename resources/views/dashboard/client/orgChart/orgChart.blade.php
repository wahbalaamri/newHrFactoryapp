                                                    ...
                                                    <div class="card-body">
                                                        <div class="row justify-content-center">
                                                            ...
                                                            <div class="alert alert-warning" role="alert">
                                                                ...
                                                                {{ __('There is no company or sector for this client, so please add one') }}
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            {{-- compnay name --}}
                                                            ...
                                                            <div class="form-group col-md-6 col-sm-12">
                                                                <label for="name">{{ __('slect sector') }}</label>
                                                                <select name="new_sector_id" id="new_sector_id"
                                                                    class="form-control">
                                                            ...
                                                            <div class="form-group col-md-6 col-sm-12">
                                                                <label for="name">{{ __('slect company siize')
                                                                    }}</label>
                                                ...
                                                <div class="col-10" id="addLevelDiv">
                                                    <div class="row row-levels">
                                                        <div class="col-md-6 col-sm-12 form-group">
                                                            <label for="levels_label[]">{{ __('Your org chart label of
                                                                Level-1') }}</label>
                                                            ...
                                                            <small class="text-muted">
                                                                {{ __('Enter label of your org chart e.g. Directorate,
                                                        ...
                                                        <div class="col-md-6 col-sm-12">
                                                            <a href="javascript:void(0)"
                                                                class="btn btn-outline-warning btn-sm" id="addLevelbtn">
...
<script>
    $("[name='is_hr']").bootstrapSwitch();
        ...
        saveOrgInfo = () => {
            company="{{ $company }}"==1? true : false;
            sector="{{ $sector }}"==1? true : false;
            if(!company && !sector){
                //validate company name company_name
                if (!$("#company_name").val()) {
                    toastr.error('Please Enter Company Name');
                    return;
                }
                //validate sector name
                if (!$("#new_sector_id").val() || $("#new_sector_id").val()=='') {
                    toastr.error('Please Enter Select Sector');
                    return;
                }
                //validate company_size
                if (!$("#company_size").val() || $("#company_size").val()=='') {
                    toastr.error('Please Enter Select Company Size');
                    return;
                }
            }
            //get data
            company_size = $("#company_size").val();
            sector_id = $("#new_sector_id").val();
        ...
        $(document).ready(function() {
                ...
                if (count < 7) {
                   ...
                   <div class="row row-levels">
                    <div class="col-md-6 col-sm-12 form-group">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <a href="javascript:void(0)" class="btn btn-outline-danger btn-xs" data-id="" onclick="removeLevel(this)" >
            ...
            removeLevel = (e) => {
                ...
                if (id) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            url = "{{ route('clients.DeleteLeveL', ':id') }}";
                            url = url.replace(':id', id);
                            //send data
                            $.ajax({
                                url: url,
            ...
            //conver php array to javascript array
            levels = @json($orgchart);
            if (levels.length > 0) {
                addLevelDiv = $("#addLevelDiv");
                levels.forEach((level, index) => {
                    if (index == 0) {
                        //set input of first child of addLevelDiv
                        addLevelDiv.children().first().find("input").val(level.user_label);
                    } else {
                        //add more level
                        addLevelDiv.append(`
                    <div class="row row-levels">
                    <div class="col-md-6 col-sm-12 form-group">
                         <div class="row">
                        <label for="levels_label[]">${level.user_label}</label>
                        <div class="col-md-6 col-sm-12">
                            <a href="javascript:void(0)" class="btn btn-outline-danger btn-xs" data-id="${level.id}" onclick="removeLevel(this)" >
                                <i class="fa fa-minus"></i></a>
                        </div>
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text">Level-${index + 1}:</span>
                            </div>
                            <input type="text" class="form-control" name="levels_label[]" value="${level.user_label}" placeholder="{{ __('Enter label of Level-${index + 1} of your org chart') }}">
                        </div>
                        <small class="text-muted">{{ __('Enter label of your org chart e.g. Directorate, Division, Department, Section or Unit') }}</small>
