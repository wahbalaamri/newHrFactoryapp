        ...
        <div class="row">
            <div class="col-12" id="finalResult">
                ...
                <div class="col-12" id="finalResult">
                    ...
                    @if (count($heat_map) > 0)
                    <div id="heat_map" class="card shadow p-3 mb-5 bg-white rounded result-card" data-title="Heat Map">
                        {{-- header --}}
                        <div class="card-header d-flex align-items-center">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        $enps=number_format($component['enps_favorable']-$component['enps_unfavorable'],
                                        2)
                                        @endphp
                                        <tr class="text-center" style="cursor: pointer;"
                                            ...
                                            <td @class([ 'bg-success'=>
                                                ...
                                                number_format($component['hand_favorable_score'], 2) < 75, 'bg-danger'=>
                                                    number_format($component['hand_favorable_score'], 2) < 40, ])>
                                            ...
                                            <td @class([ 'bg-success'=>
                                                ...
                                                number_format($component['head_favorable_score'], 2) < 75, 'bg-danger'=>
                                                    number_format($component['head_favorable_score'], 2) < 40, ])>
                                            ...
                                            <td @class([ 'bg-success'=>
                                                ...
                                                number_format($component['heart_favorable_score'], 2) <
                                                    75, 'bg-danger'=> number_format($component['heart_favorable_score'],
                                                    2) < 40, ])>
                                                        {{ number_format($component['heart_favorable_score'], 2) }}
                                            </td>
                                            <td @class([ 'bg-success'=>
                                            ...
                                            <td @class([ 'bg-success'=> $enps > 30,
                                                'bg-warning' => $enps >=0 &&$enps <=30, 'bg-danger'=> $enps < 0, ])>
                                                        {{ $enps }}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
            ...
            box-shadow: 5px 5px 20px 5px #ababab;">{{ __('Download Survey Answers') }}</a>
                                ...
                                <div class="col-4 p-3 ">
                                    ...
                                    <a href="javascript:void(0)" id="downloadButton" class="btn btn-success mt-3">{{
                                        __('Download Survey Result as Images') }}</a>
                                </div>
                                <div class="col-4 p-3 ">
