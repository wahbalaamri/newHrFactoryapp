                            ...
                            <div class="card-body">
                                <div class="row text-center">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <h6>الأهداف</h6>
                                        <p class="card-text">
                                            @if (strlen($service->objective_ar) > 0)
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <h6>{{ __('Country') }}</h6>
                                        <p class="card-text">
                                            {{ $service->country ? $service->country->name : __('Not Setted') }}
                                        </p>
                                    </div>
                                    {{-- framwork media --}}
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        @else
                                            ...
                                            <iframe width="320" height="240"
                                                src="{{ $service->framework_media_path }}" frameborder="0"
                                        ...
                                        @foreach ($service->features as $feature)
                                            <div class="list-group-item col-lg-3 mt-1 mb-1 custom-hover">
                                                ...
                                                <div class="row custom-btn-hover">
                                                    ...
                                                    @endcan
                                                    @can('delete', $feature)
                                                        <div class="col-md-6 col-sm-12 text-center"><a
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        {{-- plan --}}
                                                        <div class="col-sm-12 text-center">
                                                            <h6>{{ App()->getLocale() == 'en' ? $plan->name : $plan->name_ar }}
                                                            </h6>
                                                        </div>
                                                        <div class="col-sm-12 text-center">
                                                            <h6>{{ __('delivery mode') }}</h6> {!! App()->getLocale() == 'en' ? $plan->delivery_mode : $plan->delivery_mode_ar !!}
                                                        </div>
                                                    ...
                                                    <div class="card card-default">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="card card-success card-outline">
                                                                <div class="card-header">
                                                                    <h5 class="card-title">{{ 'Plan Delivery Mode' }}
                                                                    </h5>
                                                                </div>
                                                                <div class="card-body">
                                                                    <p id="deliveryMode_P">
                                                                    ...
                                                                    <div class="table-responsive">
                                                                        <table
                                                                            ...
                                                                            <thead>
                                                                                <tr>
                                                                                    <td colspan="5">
                                                                                        <a href="javascript:void(0)" id="AddPlanPricebtn" class="btn btn-success btn-xs" data-target="#editPlanPrice" data-toggle="modal"><i class="fa fa-plus"></i></a>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <th>#</th>
...
@section('scripts')
    <script>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    data.prices.forEach(price => {
                        //if price.country.id in data.Countries_id
                        if (data.Countries_id.includes(price.country.id)) {
                            $('#PriceTable').append(`
                    <tr>
                        <td>${loopIndex++}</td>
                ...
                `);
                    ...
                    features.forEach((feature, index) => {
                        ...
                        if (data.features_id.includes(feature.id)) {
                            $('#features_P').append(isEnglish ?
                                `<p><i class="fa fa-check text-success pr-2"></i>${feature.feature}</p>` :
                                `<p><i class="fa fa-check text-success pl-2"></i>${feature.feature_ar}</p>`
                            );
                        } else {
                            $('#features_P').append(isEnglish ?
                                `<p><i class="fa fa-times text-danger pr-2"></i>${feature.feature}</p>` :
                                `<p><i class="fa fa-times text-danger pl-2"></i>${feature.feature_ar}</p>`
                            );
                        }
                    });
                    ...
                    if (data.plan.termsConditions) {
                        $("#showTermsLabel").text(isEnglish ? data.plan.termsConditions.english_title : data
                            .plan.termsConditions.arabic_title);
                        $("TermsP").html(isEnglish ? data.plan.termsConditions.english_terms : data.plan
                            .termsConditions.arabic_terms);
        ...
        //SavePlanPrice function
        SavePlanPrice = () => {
            //get data
            var plan_price_id = $('#plan_price_id').val();
            var plan_id = $('#eplan_id').val();
            var country_id = $('#ppvalid_in').val();
            ...
            $('input.form-check-input:checked').each(function() {
                ...
                if (idstr != null) {
                    //split id by -
                    idstr = idstr.split('-')[1];
                    payment_methods.push(idstr);
                }
            });
            //check if all data is setted
            if ( country_id == '' || monthly_price == '' || annual_price == '' || currency == '' || payment_methods.length == 0) {
                toastr.error('Please fill all fields');
                return;
            }
            //set url
            var url = "{{ route('service-plans.savePlanPrice') }}";
            $.ajax({
                url: url,
                type: 'POST',
                data: {
