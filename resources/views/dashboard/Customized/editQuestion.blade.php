                ...
                <div class="col-md-12">
                    <div class="card card-outline card-success">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">{{ __('Add New Question') }}</h3>
                            <div class="card-tools">
                                <a href="{{ route('CustomizedSurvey.showQuestions',$practice->id) }}" class="btn btn-warning btn-sm">
                        ...
                        <div class="card-body">
                            {{-- form --}}
                            <form
                                action="{{ $question==null? route('CustomizedSurvey.storeQuestion',$practice->id): route('CustomizedSurvey.updateQuestion',$question->id) }}"
                                method="POST">
                                @csrf
                                @if($question!=null)
                                @method('PUT')
