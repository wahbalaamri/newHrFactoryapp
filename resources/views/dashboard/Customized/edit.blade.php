                    ...
                    <div class="card card-outline card-success">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="
                                {{ route('CustomizedSurvey.Functions',[$client,$survey]) }}
                        ...
                        <div class="card-body">
                            {{-- form --}}
                            <form action="
                            {{ $function==null? route('CustomizedSurvey.storeFunction',[$client,$survey]) : route('CustomizedSurvey.updateFunction',$function->id) }}
                            " method="POST">
                                @csrf
                                @if ($function!=null)
                                @method('PUT')
