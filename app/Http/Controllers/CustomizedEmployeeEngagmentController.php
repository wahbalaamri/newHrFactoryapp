...
class CustomizedEmployeeEngagmentController extends Controller
{
    //
    //
    private $survey;
    private $service_type = 10;
    ...
    function CopyFunctions(Request $request, $id)
    {
        return $this->survey->CopyFunctions($request ,$id,true);
    }
}
